...
public class GuideDocIterator extends NIHFOATagLibBodyTagSupport {
	...
	private static final Logger log = LogManager.getLogger(GuideDocIterator.class);
    ...
    public int doStartTag() throws JspException {
      ...
      try {
            ...
            log.error("JDBC error generating GuideDoc iterator: " + stat, e);
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Error: JDBC error generating GuideDoc iterator: " + stat);
				return parent.doEndTag();
			}else{
				throw new JspException("Error: JDBC error generating GuideDoc iterator: " + stat,e);
			}
    ...
    public int doAfterBody() throws JspException {
        try {
			...
			if(parent != null){
				pageContext.setAttribute("tagError", true);
				pageContext.setAttribute("tagErrorException", e);
				pageContext.setAttribute("tagErrorMessage", "JDBC error iterating across GuideDoc" + stat.toString());
				return parent.doEndTag();
			}else{
				throw new JspException("JDBC error iterating across GuideDoc",e);
			}
    ...
    public int doEndTag() throws JspTagException, JspException {
        try {
			...
			if(parent != null){
				...
				throw new JspException("Error: JDBC error ending GuideDoc iterator",e);
			}
