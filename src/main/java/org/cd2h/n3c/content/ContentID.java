...
public class ContentID extends NIHFOATagLibTagSupport {
	...
	private static final Logger log = LogManager.getLogger(ContentID.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Error: Can't find enclosing Content for ID tag ");
