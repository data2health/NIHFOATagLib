...
public class ContentDeleter extends NIHFOATagLibBodyTagSupport {
	...
	private static final Logger log = LogManager.getLogger(ContentDeleter.class);
    ...
    public int doStartTag() throws JspException {
        ...
        try {
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Error: JDBC error generating Content deleter");
				return parent.doEndTag();
			}else{
				throw new JspException("Error: JDBC error generating Content deleter",e);
			}
