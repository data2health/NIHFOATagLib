...
public class NIHFOATagLibTagSupport extends TagSupport {

    protected DataSource theDataSource = null;
    protected Connection theConnection = null;
    private static final Logger log = LogManager.getLogger(NIHFOATagLibTagSupport.class);

    public NIHFOATagLibTagSupport() {
        super();
    }
