...
public class InterestDeleter extends NIHFOATagLibBodyTagSupport {
	...
	private static final Logger log = LogManager.getLogger(InterestDeleter.class);
    ...
    public int doStartTag() throws JspException {
        ...
        try {
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Error: JDBC error generating Interest deleter");
				return parent.doEndTag();
			}else{
				throw new JspException("Error: JDBC error generating Interest deleter",e);
			}
