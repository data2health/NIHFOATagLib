...
public class NIHFOATagLibBodyTagSupport extends BodyTagSupport {

    protected DataSource theDataSource = null;
    protected Connection theConnection = null;

    public NIHFOATagLibBodyTagSupport() {
        super();
    }

    private static final Logger log = LogManager.getLogger(NIHFOATagLibBodyTagSupport.class);
